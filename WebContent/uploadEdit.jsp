...
<html>
	...
	<body>
		...
		<s:form method="post" theme="simple" action="uploadEdit"
			...
			<table align="center">
				...
				<tr align="center">
					...
					<td>
						...
						<%--获取已上传的文件id --%>
						<s:hidden id="fileId" name="fileId" value="%{id}"></s:hidden>
 						<INPUT id="close" onclick="closee();" type="submit" value="关闭">
					</td>
				</tr>
			</table>
			<input style="display:none" id="doc_id" name="doc_id" value="<%= request.getParameter("doc_id")%>"></input>
		</s:form>
